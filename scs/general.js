...
adams({ nomCom: "dev", categorie: "General", reaction: "😋" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "VIRUSI 🦠 MBAYA HIV", numero: "254769995625" },
      { nom: "᚛VIRUSI 🦠 MBAYA HIV᚜", numero: "254756965035" },
      { nom: "Stainer C", numero: "254739285768" },
...
adams({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  repondre("THANK YOU FOR CHOOSING MAKAMESCO , HERE ARE OUR SUPPORTIVE LINKS\n\n ☉ CHANNEL LINK IS HERE ☉ \n\n❒⁠⁠⁠⁠[https] \n\n ☉ GROUP LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://chat.whatsapp.com/] \n\n ☉YOUTUBE LINK IS HERE ☉\n\n❒⁠⁠⁠⁠[https://youtube.com/@ngwathegangofficial?si=BAbV9LE3e68F00bS]") 
