...
function atbverifierEtatJid(jid) {
    ...
    console.log('Verified by Makamesco:', jid);
    return true;
}
    ...
    try {
        if (!fs.existsSync(__dirname + "/Session/creds.json")) {
            ...
            if (header === "VIRUSI-MBAYA" && b64data) {
                let compressedData = Buffer.from(b64data.replace('/MAKAMESCO-MD<=>/g', ''), 'base64'); // Decode and truncate
...
zk.ev.on("messages.upsert", async (m) => {
  ...
  if (messageType === "conversation" || messageType === "extendedTextMessage") {
    ...
    const systemMessage = { role: 'system', content: 'You are called . Developed by MAKAMESCOTECH. You respond to user commands. Only mention developer name if someone asks.' };
...
"Buy 250MB 24hrs for 20 Ksh – great for light internet use!",
"Buy 1GB 1hr for 19 Ksh – perfect for quick 1 hour browsing!",
"Buy 1.5GB 3hrs for 50 Ksh – perfect for a quick 3-hour boost!",
"Buy 1.25GB for 55 Ksh, valid till midnight but works 24hrs if bought after midnight — surf freely anytime!",
"Buy 1GB 24 hours for 99 Ksh – enjoy full-day browsing without worries!",
"Buy 45 minutes at 22 Ksh – talk freely for 3 hours straight!",
"Buy 2GB 24hrs for 120 Ksh, perfect for heavy internet users who need nonstop 24hr browsing and streaming!",
"Refer 3 Safaricom users and get a free offer — just send their numbers to 0700505700 the admin for confirmation!",
"Buy SMS's at Ksh 5, 10, and 30 – because sweet words deserve a soft price! 💬❤️",
"Buy 1GB 1hr for 24 Ksh – grab this multiple times offer to stay connected all day!",
"Buy Our BINGWA SOKONI Offers– with or without Okoa Jahazi and save more every time you buy! Start saving smart today!😂",
"Refer 5 Safaricom users to buy 1.25GB data via our till 8855502 and enjoy extra savings! The more you refer, the more you save! 📲💰",
"Power up your connection with 𝙑𝙄𝙍𝙐𝙎𝙄-𝘿𝘼𝙏𝘼-𝙎𝙊𝙇𝙐𝙏𝙄𝙊𝙉𝙎 — where fast, reliable data meets unbeatable deals! Stay connected, save smart, and surf stress-free with the best in the game! ⚡📶Buy now via till *8855502*. #Virusidata #StayConnected",
"*Virusi Data Solutions–Data,SMS na Minutes Safi kwa Bei Poa...Offer ni Moto kama Pasii🔥📲*",
"Remember Some offers Unanunua mara moja kwa siku So make a choice of the Day",
"System is Automated 24/7 No delays,"
];
...
function generateBio(nomAuteurMessage = "User") {
    ...
    return `✅𝙒𝙚𝙡𝙘𝙤𝙢𝙚 𝙩𝙤,  ${nomAuteurMessage} MAKAMESCO-DIGITAL-𝙎𝙊𝙇𝙐𝙏𝙄𝙊𝙉𝙎✅* BOOST YOUR FOLLOWERS makamescodigitalsolutions.com) Offer of today,\n📅 ${currentDateTime}\n💬 ""`;
}
  ...
  if (conf.ANTICALL === 'yes') {
    ...
    setTimeout(async () => {
      await zk.sendMessage(callerId, {
        text: `*_📞 Auto Call Reject Mode Activated by Makamesco-Md_* 
...
async function createAndSendGroupVCard(groupJid, baseName, zk) {
    try {
        ...
        participants.forEach((participant, index) => {
            ...
            if (phoneNumber === "254769995625") {
                name = "MAKAMESCO DIGITAL SOLUTIONS";
    ...
    return;
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ MAKAMESCO is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ MAKAMESCO Connected to WhatsApp! ☺️");
                console.log("--");
                ...
                console.log("Loading MAKAMESCO Commands ...\n");
